...
func _ready() -> void:
	...
	_empty_tex_disable.atlas = UI_EMPTY_ATLAS
	_empty_tex_disable.region = Rect2(Vector2(Skill.UI_SMALL_DIMENSIONS.x, 0), Skill.UI_SMALL_DIMENSIONS)
	texture_normal = _empty_tex
